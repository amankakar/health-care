  ...
  function hospitalDetails() {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(event) {
        var accounts, ContractFactory, instanceFactory, appoint;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 24:
                _context4.next = 26;
                return instanceFactory.appointements.call(parseInt(_this.state.appointmentId));

              case 26:
                appoint = _context4.sent;

                _this.setState({
                  appointmentResult: appoint
                });

                console.log("appointm:", _this.state.appointmentResult[0].toNumber(), _this.state.appointmentResult[1].toNumber(), _this.state.appointmentResult[2].toNumber(), _this.state.appointmentResult[3], _this.state.appointmentResult[4]);
...
//# sourceMappingURL=hospitalDetails.js.7c2c2fca29a3f82c6630.hot-update.js.map