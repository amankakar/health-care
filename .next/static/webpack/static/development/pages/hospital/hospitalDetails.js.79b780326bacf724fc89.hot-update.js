  ...
  function hospitalDetails() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderDropDownPatient", function (patienId) {
      ...
      var patientArray = _this.state.patientIdArray.map(function (element, index) {
        ...
        return;
        {
          index: [index], element, element.toNumber();
        }
      });

      var options = patientArray.map(function (element, index) {
        return {
          key: index,
          text: element,
          value: element
...
//# sourceMappingURL=hospitalDetails.js.79b780326bacf724fc89.hot-update.js.map