...
function (_Component) {
  ...
  function hospitalDetails() {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                console.log(_this.state.currentDoctorValue); //console.log(this.state.date1);
              ...
              case 12:
                ...
                _context4.prev = 14;
                _context4.next = 17;
                return instanceReceptionist.createAppointment(_this.state.appointmentId, _this.state.currentPatientValue, _this.state.currentDoctorValue, _this.state.date, _this.state.textArea, {
                  from: accounts[0]
                });
              ...
              case 22:
                _context4.next = 24;
                return instanceReceptionist.appointements.call(_this.state.appointmentId);

              case 24:
                appoint = _context4.sent;
                console.log("appointm:", appoint[4]);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderDropDownDoctor", function (doctorId) {
      ...
      console.log("patient Array:", doctorArray); // const options = [
...
//# sourceMappingURL=hospitalDetails.js.70e3d5992868c641287c.hot-update.js.map