...
function (_Component) {
  ...
  function hospitalDetails() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderDropDownDoctor", function (doctorId) {
      ...
      var patientArray = _this.state.doctorIdArray.map(function (element, index) {
        //console.log("element:", index, element.toNumber());
        var element1 = element.toNumber().toString();
        return {
          key: index,
      ...
      console.log("options :", options);
      console.log("patient Array:", patientArray); // const options = [
...
//# sourceMappingURL=hospitalDetails.js.c0d89f4732b84c7af26b.hot-update.js.map