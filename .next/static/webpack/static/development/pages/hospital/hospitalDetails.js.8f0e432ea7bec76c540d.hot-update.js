  ...
  function hospitalDetails() {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event) {
        var admin, accounts, Factory, patientFactoryInstance, patientList;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 16:
                ...
                if (_this.props.manager === accounts[0]) {
                  ...
                  _this.renderDropDownPatient(); //Patient factory
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
      var Factory, Contract, patientFactoryInstance, accounts, result, patientinstanceAddress, patientInstance, summary, patientList, patient;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 38:
              ...
              console.log("patientList:", _this.state.patientIdArray);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "prepareDropDown",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this.props.patientFactoryInstance.getPatientList.call();

            case 2:
              patientList = _context3.sent;
              _context3.next = 5;
              return Promise.all(Array(parseInt(patientList)).fill().map(function (element, index) {
                return patientFactoryInstance.patientId.call(index); // .then((element , index)=>{
                //
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                doctorFactoryInstance = _context4.sent;
                _context4.prev = 3;
                _context4.next = 6;
                return _ethereum_web3__WEBPACK_IMPORTED_MODULE_16__["default"].eth.getAccounts();
              ...
              case 18:
                doctorInstanceAddress = _context4.sent;
                _context4.next = 21;
                return Contract.at(doctorInstanceAddress);

              case 21:
                doctorInstance = _context4.sent;
                _context4.next = 24;
                return doctorFactoryInstance.getDoctorList.call();

              case 24:
                doctorList = _context4.sent;
  ...
  _createClass(hospitalDetails, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee6(props) {
        var address, accounts, ContractReceptionist, instanceReceptionist, hospitalSummary, optionsArray, Factory, Contract, doctorFactoryInstance, FactoryPatient, patientFactoryInstance;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 22:
                ...
                FactoryPatient.setProvider(_ethereum_web3__WEBPACK_IMPORTED_MODULE_16__["default"].currentProvider); //  console.log(Factory);
                //PatinentContract
...
//# sourceMappingURL=hospitalDetails.js.8f0e432ea7bec76c540d.hot-update.js.map