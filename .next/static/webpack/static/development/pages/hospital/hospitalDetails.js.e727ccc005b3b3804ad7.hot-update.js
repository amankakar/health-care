  ...
  function hospitalDetails() {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event) {
        var admin, accounts, Factory, patientFactoryInstance, patientList, FactoryDoctor, doctorFactoryInstance, doctorList;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 16:
                ...
                FactoryDoctor = truffle_contract__WEBPACK_IMPORTED_MODULE_17___default()(_build_contracts_DoctorFactory_json__WEBPACK_IMPORTED_MODULE_8__); //  console.log(Factory);

                FactoryDoctor.setProvider(_ethereum_web3__WEBPACK_IMPORTED_MODULE_16__["default"].currentProvider);
                console.log(FactoryDoctor);
                _context.next = 24;
                return FactoryDoctor.deployed();

              case 24:
                doctorFactoryInstance = _context.sent;
                _context.next = 27;
              ...
              case 27:
                ...
                _this.prepareDoctorDropdown(); // const FactoryDoctor = truffleContract(DoctorFactory);
                // //  console.log(Factory);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 30:
              ...
              _this.preparePatientDropDown(); // const patientList = await patientFactoryInstance.getPatientList.call();
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(event) {
        var FactoryDoctor, doctorFactoryInstance, accounts, result, doctorInstanceAddress, doctorList;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 23:
                ...
                _this.prepareDoctorDropdown(); // const requests = await Promise.all(
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(event) {
        var accounts, ContractFactory, instanceFactory;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                console.log(moment__WEBPACK_IMPORTED_MODULE_12___default()(_this.state.myDate).format("LLL"));
              ...
              case 9:
                ...
                ContractFactory = truffle_contract__WEBPACK_IMPORTED_MODULE_17___default()(_build_contracts_ReceptionsitFactory_json__WEBPACK_IMPORTED_MODULE_4__);
                ContractFactory.setProvider(_ethereum_web3__WEBPACK_IMPORTED_MODULE_16__["default"].currentProvider);
                _context4.next = 14;
              ...
              case 14:
                ...
                _context4.prev = 16;
                _context4.next = 19;
                return instanceFactory.createAppointment(_this.state.appointmentId, _this.state.currentPatientValue, _this.state.currentDoctorValue, moment__WEBPACK_IMPORTED_MODULE_12___default()(_this.state.myDate).format("LLL"), _this.state.textArea, // 123,
                // 456,
                // 567,
                // "12/14/2018",
                // "fhklolp",
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                ...
                _context5.next = 8;
                return instanceFactory.appointements.call(parseInt(_this.state.appointmentIdSearch));
              ...
              case 8:
                ...
                _this.setState({
                  appointmentResult: appointmentResult[0].toNumber(),
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSearch", function () {
      if (_this.state.appointmentResult) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "Appointement Id:", _this.state.appointmentIdResult), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "Patient Id: ", _this.state.patientIdResult), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "Doctor Id:", _this.state.doctorIdresult), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "Date: ", _this.state.dateResult), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "Chep Complaint:", _this.state.chepComplaintResult));
      } else {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePatientChange", function (e, _ref6) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDoctorChange", function (e, _ref7) {
  ...
  _createClass(hospitalDetails, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee6() {
        var FactoryPatient, patientFactoryInstance, patientList, patient;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                FactoryPatient = truffle_contract__WEBPACK_IMPORTED_MODULE_17___default()(_build_contracts_PatientFactory_json__WEBPACK_IMPORTED_MODULE_6__); //  console.log(Factory);

                FactoryPatient.setProvider(_ethereum_web3__WEBPACK_IMPORTED_MODULE_16__["default"].currentProvider);
                _context6.next = 4;
                return FactoryPatient.deployed();
              ...
              case 7:
                ...
                return Promise.all(Array(parseInt(patientList)).fill().map(function (element, index) {
                  return patientFactoryInstance.patientId.call(index); // .then((element , index)=>{
                  //
                  // })
                  // ;
                }));
      ...
      return function preparePatientDropDown() {
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee7() {
        var FactoryDoctor, doctorFactoryInstance, doctorList, doctor;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 7:
                ...
                _context7.next = 10;
                return Promise.all(Array(parseInt(doctorList)).fill().map(function (element, index) {
                  return doctorFactoryInstance.doctorId.call(index); // .then((element , index)=>{
                  //
                  // })
                  // ;
                }));
      ...
      return function prepareDoctorDropdown() {
      ...
      var panes = [{
        ...
        render: function render() {
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Tab"].Pane, {
            ...
            widths: "equal"
          }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Form"].Field, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("label", null, "Patient ID"), _this2.renderDropDownPatient()), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Form"].Field, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("label", null, "Doctor ID"), _this2.renderDropDownDoctor())), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Form"].Field, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Form"].TextArea, {
    ...
    value: function render() {
      ...
      }, "Admin Panel"), this.renderTabs(), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("hr", null)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_toggle_display__WEBPACK_IMPORTED_MODULE_3___default.a, {
        show: !this.state.show
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee8(props) {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 12:
                ...
                console.log("S", hospitalSummary); //  console.log(Factory);
                //PatinentContract
...
//# sourceMappingURL=hospitalDetails.js.e727ccc005b3b3804ad7.hot-update.js.map