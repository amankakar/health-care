...
function (_Component) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 27:
                ...
                _assertThisInitialized(_assertThisInitialized(_this)), setState({
                  doctorIdArray: doctorList
                });

                _this.prepareDcotorDropdown(); // const FactoryDoctor = truffleContract(DoctorFactory);
                // //  console.log(Factory);
  ...
  _createClass(hospitalDetails, [{
    ...
    key: "prepareDcotorDropdown",
    value: function () {
      var _prepareDcotorDropdown = _asyncToGenerator(
      /*#__PURE__*/
      ...
      return function prepareDcotorDropdown() {
        return _prepareDcotorDropdown.apply(this, arguments);
      };
    }() //Add Doctor
...
//# sourceMappingURL=hospitalDetails.js.6ed63b41b1f91886ac19.hot-update.js.map